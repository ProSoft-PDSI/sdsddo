...
insert into producto values ('EN01','Trio','Disfrute de las alas de pollo al horno, trozos de papa y 4 piezas de pollo con un nuevo manjar de salsa barbacoa..','images/ent_1.png',10.50,60,'admin');
insert into producto values ('EN02','Palitos de Queso','Deliciosos palitos de queso mozzarella, acompañda de salsa de tomate..','images/ent_2.png',5.50,60,'admin');
insert into producto values ('EN03','Pan al Ajo','El favorito de todos, nuestro crujiente pan al ajo bañado con queso mozzarella..','images/ent_3.png',10.50,60,'admin');
insert into producto values ('EN04','Palitos a la Toscana','Exquisito palitos rellenos de queso mozzarella, jamon y tocino','images/ent_4.png',10.50,60,'admin');
insert into producto values ('EN05','Alitas de pollo','Alitas de pollo marinado y horneado con nuestra exclusiva receta de salsa picante.','images/ent_5.png',10.50,60,'admin');
insert into producto values ('EN06','Enrrollado de pollo','Deliciosa masa recubierta con queso parmesano lleno de pollo y su salsa de barbacoa, horneados a la perfección.','images/ent_6.png',10.50,60,'admin');
